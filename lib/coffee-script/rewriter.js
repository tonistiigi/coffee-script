(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.rewrite = function(tokens) {
      ...
      this.addMissingUndefinedArguments();
      return this.tokens;
    };
    ...
    Rewriter.prototype.addMissingUndefinedArguments = function() {
      return this.scanTokens(function(token, i) {
        var _ref;
        if (token[0] === "," && ((_ref = this.tokens[i - 1][0]) === "," || _ref === "[")) {
          this.tokens.splice(i, 0, ['BOOL', 'undefined', 0]);
        }
        return 1;
      });
    };
